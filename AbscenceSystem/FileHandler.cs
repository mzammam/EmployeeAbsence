...
*/
        ...
        public void ScanAndUpdate()
        {
            ...
            {
                foreach (var emp in empRec.Value)
                {
                    FindAndUpdateRecord(emp);
                }
        ...
        private void FindAndUpdateRecord(Employee emp)
        {
            ...
            //var y = x.SelectMany(a => a.Value.FindAll(b => b.AbsenceType == AbsenceType.One));
